...
const PageLayout: FunctionComponent<PropsWithChildren<Props>> = ({ children, pageTitle }) => {
  return (
    <>
      <div className="page-layout pb-8 mx-auto max-w-7xl px-4 space-y-8 sm:px-6 lg:px-8 dark:bg-slate-800">
        <Head>
          <title>{pageTitle}</title>
          <meta name="description" content="Generated by create next app" />
          <link rel="icon" href="/favicon.ico" />
        </Head>
        <div className="relative bg-white dark:bg-slate-800 pb-8 lg:w-full lg:max-w-2xl">
          <Navbar />
        </div>
